...
public class CodeGenerator {
	...
	public static String getModifiedJavaCode(String className, ListView<ComponentMenuItem> leftList,
		...
		String importsString =LabelGrabber.getLabel("codegenerator.autogeneratedimports")+"\n";
		for (String s : imports) {
			importsString += s;
		}
		importsString += LabelGrabber.getLabel("codegenerator.endautogeneratedimports")+"\n";

		code = TextBearbeiter.ersetzeTextbereich(LabelGrabber.getLabel("codegenerator.autogeneratedimports"), LabelGrabber.getLabel("codegenerator.endautogeneratedimports"),
				code, importsString);
...
//		System.err.println(code);
		...
		declarationString += LabelGrabber.getLabel("codegenerator.autogenerateddeclarations")+"\n";
		for (String s : declarations) {
			declarationString += s;
		}
		declarationString += LabelGrabber.getLabel("codegenerator.endautogenerateddeclarations")+"\n";
		code = TextBearbeiter.ersetzeTextbereich(LabelGrabber.getLabel("codegenerator.autogenerateddeclarations"),
				LabelGrabber.getLabel("codegenerator.endautogenerateddeclarations"), code, declarationString);
		String getRootString = LabelGrabber.getLabel("codegenerator.autogeneratedroot")+"\n";
		...
		getRootString += "        "+LabelGrabber.getLabel("codegenerator.insertinrootbegin")+"\n";
		code = TextBearbeiter.ersetzeTextbereich(LabelGrabber.getLabel("codegenerator.autogeneratedroot"), LabelGrabber.getLabel("codegenerator.insertinrootbegin"), code,
				getRootString);
		getRootString = "        "+LabelGrabber.getLabel("codegenerator.insertinrootend")+"\n";
		getRootString += "        return " + guiObject.getFieldName() + ";\n";
		getRootString += "    }\n\n";
		getRootString += "    "+LabelGrabber.getLabel("codegenerator.endautogeneratedroot")+"\n";
		code = TextBearbeiter.ersetzeTextbereich(LabelGrabber.getLabel("codegenerator.insertinrootend"), LabelGrabber.getLabel("codegenerator.endautogeneratedroot"), code,
				getRootString);
	...
	public static String generateJavaCode(String className, ListView<ComponentMenuItem> leftList, GUIObject guiObject,
		...
		importsString.append(LabelGrabber.getLabel("codegenerator.autogeneratedimports")+"\n");
		for (String s : imports) {
			importsString.append(s);
		}
		importsString.append(LabelGrabber.getLabel("codegenerator.endautogeneratedimports")+"\n");
		...
		declarationString.append(LabelGrabber.getLabel("codegenerator.autogenerateddeclarations")+"\n");
		for (String s : declarations) {
			declarationString.append(s);
		}
		declarationString.append(LabelGrabber.getLabel("codegenerator.endautogenerateddeclarations")+"\n");
...
//
//			code.append(LabelGrabber.getLabel("codegenerator.enablesbluejinspection")+"\n"
//					+ "    public void go() {\n" + "        new JFXPanel();\n"
//					+ "        Platform.runLater( ()->{start(new Stage());});\n"+ "    }\n\n");
			code.append("    public " + clName + "(){\n");

			code.append("    "+LabelGrabber.getLabel("codegenerator.enablebluejinspection")+"\n"
					+"        new JFXPanel();\n"
					+ "        Platform.runLater( ()->{start(new Stage());});\n"+ "    }\n\n");
			
		}
		
		code.append("    "+LabelGrabber.getLabel("codegenerator.autogeneratedroot")+"\n");
...
//		code.append("\n");
		...
		code.append("        "+LabelGrabber.getLabel("codegenerator.insertinrootbegin")+"\n");
		code.append("        "+LabelGrabber.getLabel("codegenerator.insertinrootend")+"\n");
		code.append("        return " + guiObject.getFieldName() + ";\n");
		code.append("    }\n");
		code.append("    "+LabelGrabber.getLabel("codegenerator.endautogeneratedroot")+"\n");

...
public class CodeGenerator {
	...
	public static String getModifiedJavaCode(String className, ListView<ComponentMenuItem> leftList, String existingCode, GUIObject guiObject	) {
...
//		alert.showAndWait();
	...
	public static String generateJavaCode(String className, ListView<ComponentMenuItem> leftList, GUIObject guiObject, boolean forPreview) {
		HashMap<String, String> allImports = new HashMap<>();
		for (ComponentMenuItem componentMenuItem :leftList.getItems()) {
			ComponentSettings componentSettings = componentMenuItem.getComponentSettings();
			allImports.put(componentSettings.getType(), componentSettings.getPackageName());

...
public class StyleBackgroundObservedProperty implements PanelProperty {
    ...
    public StyleBackgroundObservedProperty(final GObject gObj, String name, final String observedProperty, String getter, final String setter, String fxml, String defaultValue, GridPane gp, int row, Node settingsNode, HistoryManager hm) {
        this.gObj = gObj;
        this.setter = setter;
        this.getter = getter;
        this.fxml = fxml;
        ...
        if (settingsNode != null) {
            try {
                ...
                String value = getStylevalue("-fx-background-color",settingsNode.getStyle());

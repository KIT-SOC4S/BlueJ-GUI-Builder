...
public class IntegerObservedProperty implements PanelProperty {
    ...
    public IntegerObservedProperty(final GObject gObj, String name, final String observedProperty,  String fxml, String defaultValue, GridPane gp, int row, Node settingsNode, HistoryManager hm) {
        this.gObj = gObj;
//      this.setter = setter;
//      this.getter = getter;
